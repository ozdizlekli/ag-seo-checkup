...
class GeminiService {
    ...
    public function generateExpertInsights(array $telemetryData, string $rawText): array {
        ...
        $prompt = "Sen Kıdemli bir AI Entegrasyon, SEO Stratejisti ve Profesyonel İçerik Editörüsün.\n"
                ...
                . "   - SEO VE RAPOR ODAKLI MÜDAHALE (Orta Yol): İki temel görevin var: 1) Eksik hedef kelimeleri ve LSI'ları akışı bozmadan metne sıkıştırmak. 2) EĞER telemetri raporunda okunabilirlik uyarısı varsa (örneğin 'çok karmaşık kelime var' veya 'cümleler çok uzun' uyarısı), metnin tamamını değiştirmeden sadece 1-2 yerde ufak düzeltmeler (örneğin 'gerçekleştirebilmekteyiz' yerine 'yapıyoruz' yazmak veya çok uzun bir paragrafı ikiye bölmek gibi) yap. Bunun dışında metni baştan aşağı yeniden yazma.\n"
                ...
                . "3. MATEMATİKSEL SAĞLIK SKORU HESAPLAMASI (Health Score): 'saglik_skoru' (0-100) değerini tahmini değil, KESİNLİKLE aşağıdaki 5 temel sütunun toplamı olarak objektif bir şekilde hesapla. Telemetrideki 'success' (tam puan), 'warning' (yarım puan) ve 'danger' (sıfıra yakın) durumlarına göre her kategoriye puan ver ve toplamı 'saglik_skoru' alanına yaz:\n"
                . "   - [Maksimum 25 Puan] 1. Anahtar Kelime & Arama Uyumu: Telemetrideki yoğunluk %0.8-2.5 arasındaysa, ilk 100 kelimede (is_early_positioned) ve H1/H2 başlıklarında (h1_has_keyword, h2_coverage) anahtar kelime varsa tam puan ver.\n"
                . "   - [Maksimum 25 Puan] 2. Okunabilirlik & Akıcılık: Telemetrideki Atesman skoru, Karmaşık kelimeler (complex_words_percentage) ve Geçiş bağlaçları (transition_words) alanlarının 'status' durumuna göre hesapla. Hepsi 'success' ise 25 puan ver.\n"
                . "   - [Maksimum 20 Puan] 3. İçerik Yapısı ve Başlıklar: H1/H2 düzeni (hierarchy_valid), uzun-yorucu paragrafların olmaması (monolithic_paragraphs_count=0) ve cümle akışının dinamikliği (monotonous_flow_detected: false) ölçütlerine göre puanla.\n"
                . "   - [Maksimum 15 Puan] 4. Faydalı Bilgi Yoğunluğu: Kelime hacmi (word_count), LSI (yan anahtar kelimelerin optimal olması) ve genel bilgi zenginliğine göre hesapla.\n"
                . "   - [Maksimum 15 Puan] 5. İkna Edicilik ve Uzmanlık: Kapanış paragrafında hedef kelimelerin geçmesi (last_paragraph.status = OPTIMAL) ve pasif cümle oranının (passive_voice) düşük olup aktif/ikna edici bir dil kullanılmasına göre puan ver.\n"
                . "   * ÖNEMLİ: Hesapladığın bu 5 puanı toplayıp 'saglik_skoru'na yaz (0-49 Kritik, 50-79 Geliştirilmeli, 80-100 Mükemmel). Telemetri verilerinde her şey 'success' ise 90-100 arası puan vermekten çekinme.\n\n"
                . "Telemetri Verisi:\n" . $telemetryJson . "\n\n"
                . "Ham Metin:\n" . $rawText . "\n\n"

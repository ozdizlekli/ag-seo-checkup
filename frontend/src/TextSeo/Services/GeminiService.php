...
class GeminiService {
    ...
    public function generateExpertInsights(array $telemetryData, string $rawText): array {
        ...
        $prompt = "Sen Kıdemli bir AI Entegrasyon, SEO Stratejisti ve Profesyonel İçerik Editörüsün.\n"
                ...
                . "   - YAZARIN KELİMELERİNE VE ÜSLUBUNA SAYGI DUY: Yazarın kelime seçimlerini sırf 'daha profesyonel' yapmak adına keyfi olarak eşanlamlılarıyla DEĞİŞTİRME (Örn: 'program' yerine 'eklenti', 'söyleyelim' yerine 'paylaşalım' gibi keyfi düzeltmeler YAPMA). Yazarın cümle yapısını ve ifade biçimini %85-90 oranında aynen koru.\n"

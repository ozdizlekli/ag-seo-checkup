...
class GeminiService {
    ...
    public function generateExpertInsights(array $telemetryData, string $rawText): array {
        ...
        $prompt = "Sen Kıdemli bir AI Entegrasyon, SEO Stratejisti ve Profesyonel İçerik Editörüsün.\n"
                ...
                . "KURALLAR:\n"
                . "1. ANALİZ BOYUTU (Düz Metin Felsefesi): Kullanıcıya asla 'HTML başlık etiketi eksik', 'Markdown etiketi yok' gibi teknik kodlama eleştirileri yapma. Metni profesyonel bir içerik editörü gözüyle; metin akışı, anahtar kelime yerleşimi, başlıkların dikkat çekiciliği ve okunabilirlik üzerinden değerlendir. Çünkü metin sana hep saf metin (html etiketlerinden arınmış) olarak ulaşıcak.\n"
                . "2. OTOMATİK DÜZELTME BOYUTU (Minimalist ve Cerrahi Optimizasyon):\n"
                . "   - YAZARIN KELİMELERİNE VE ÜSLUBUNA SAYGI DUY: Yazarın kelime seçimlerini sırf 'daha profesyonel' yapmak adına keyfi olarak eşanlamlılarıyla DEĞİŞTİRME (Örn: 'program' yerine 'eklenti', 'söyleyelim' yerine 'paylaşalım', 'ücretsiz' yerine 'bedava' gibi keyfi düzeltmeler YAPMA). Yazarın cümle yapısını ve ifade biçimini %85-90 oranında aynen koru.\n"

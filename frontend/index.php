            ...
            <div class="copilot-header">
              <div class="copilot-progress" id="copilot-progress" style="display:none;">
                ...
                <div class="copilot-step" data-step="2" id="cp-step-2">
                  ...
                  <span class="has-tooltip" data-tooltip="Kullanıcıların bu sayfa bağlamında sorabileceği en kritik sorular ve sitenizin bunlara verdiği cevapların kalitesi ölçülür.">Etkililik</span>
                ...
                <div class="copilot-step" data-step="3" id="cp-step-3">
                  ...
                  <span class="has-tooltip" data-tooltip="Sektördeki en güçlü rakiplere kıyasla sitenizin içerik açısından hangi noktalarda eksik kaldığı tespit edilir.">Rakip Analizi</span>
                ...
                <div class="copilot-step" data-step="4" id="cp-step-4">
                  ...
                  <span class="has-tooltip" data-tooltip="E-E-A-T (Deneyim, Uzmanlık, Otoriterlik, Güvenilirlik) kurallarına göre sitenizin yapay zekaya ne kadar güven verdiği puanlanır.">AI Güveni</span>
                ...
                <div class="copilot-step" data-step="5" id="cp-step-5">
                  ...
                  <span class="has-tooltip" data-tooltip="SGE (Search Generative Experience) ile uyumlu, okunabilirliği yüksek yepyeni bir içerik taslağı sunulur.">Optimizasyon</span>
                ...
                <div class="copilot-step" data-step="6" id="cp-step-6">
                  ...
                  <span class="has-tooltip" data-tooltip="Yapay zekanın sitenizi sadece kelime kelime değil, anlamsal bir bütün (Semantik ve Şema) olarak nasıl algıladığı özetlenir.">Entegrasyon</span>

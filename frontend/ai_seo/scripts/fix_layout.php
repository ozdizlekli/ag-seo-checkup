...
// The boundaries of tab-3
$start_pattern = '<section class="tab-panel" id="tab-3">';
$end_pattern = '<!-- YENİ 4. SEKME: YAPILACAKLAR / EKSİKLİKLER -->';

$pos_start = strpos($index, $start_pattern);
$pos_end = strpos($index, $end_pattern);
  ...
  <div id="copilot-action-view" style="display: none; flex-direction: column; gap: 16px; min-height: 80vh;">
    ...
    <div style="display:flex; justify-content:center; width:100%; border-top: 1px solid var(--border); padding-top:16px; margin-top:8px;">
        <div class="copilot-progress" id="copilot-progress" style="display: flex; justify-content: center; align-items: center; gap: 12px; width: 100%; overflow-x: auto; padding-bottom: 4px;">
            ...
            <!-- ADIM 1 -->
            <div class="copilot-step info-tooltip completed" data-step="1" id="cp-step-1" style="cursor: pointer;">
                <div class="copilot-step-circle"><span class="num">1</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                <div class="step-label-wrapper">
                    <span>İş Bağlamı</span>
                </div>
                <div class="tooltip-text">
                    İş Bağlamı (Bağlamsal Alaka) analizi.
                    <br><br>
                    <span style="font-size: 10px; font-style: italic; color: #cbd5e1;">Sohbette bu adıma gitmek için tıklayın</span>
                </div>
            </div>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" color="var(--border)"><path d="M9 18l6-6-6-6"></path></svg>

            <!-- ADIM 2 -->
            <div class="copilot-step info-tooltip completed" data-step="2" id="cp-step-2" style="cursor: pointer;">
                <div class="copilot-step-circle"><span class="num">2</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                <div class="step-label-wrapper">
                    <span>Etkililik</span>
                </div>
                <div class="tooltip-text">
                    Kullanıcı niyeti ve etkililik analizi.
                    <br><br>
                    <span style="font-size: 10px; font-style: italic; color: #cbd5e1;">Sohbette bu adıma gitmek için tıklayın</span>
                </div>
            </div>
            ...
            <!-- ADIM 3 -->
            <div class="copilot-step info-tooltip completed" data-step="3" id="cp-step-3" style="cursor: pointer;">
                <div class="copilot-step-circle"><span class="num">3</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                <div class="step-label-wrapper">
                    <span>Rakip Analizi</span>
                </div>
                <div class="tooltip-text">
                    Rakiplere kıyasla eksik içerik/değer boşlukları analizi.
                    <br><br>
                    <span style="font-size: 10px; font-style: italic; color: #cbd5e1;">Sohbette bu adıma gitmek için tıklayın</span>
                </div>
            </div>
            ...
            <!-- ADIM 4 -->
            <div class="copilot-step info-tooltip completed" data-step="4" id="cp-step-4" style="cursor: pointer;">
                <div class="copilot-step-circle"><span class="num">4</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                <div class="step-label-wrapper">
                    <span>AI Güveni</span>
                </div>
                <div class="tooltip-text">
                    Yapay zeka sistemleri nezdinde marka güveni ve otorite (E-E-A-T) analizi.
                    <br><br>
                    <span style="font-size: 10px; font-style: italic; color: #cbd5e1;">Sohbette bu adıma gitmek için tıklayın</span>
                </div>
            </div>
            ...
            <!-- ADIM 5 -->
            <div class="copilot-step info-tooltip completed" data-step="5" id="cp-step-5" style="cursor: pointer;">
                <div class="copilot-step-circle"><span class="num">5</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                <div class="step-label-wrapper">
                    <span>Optimizasyon</span>
                </div>
                <div class="tooltip-text">
                    Okunabilirlik, Şema yapıları ve kullanıcı deneyimi (UX/UI) sorunları.
                    <br><br>
                    <span style="font-size: 10px; font-style: italic; color: #cbd5e1;">Sohbette bu adıma gitmek için tıklayın</span>
                </div>
            </div>
            ...
            <!-- ADIM 6 -->
            <div class="copilot-step info-tooltip completed" data-step="6" id="cp-step-6" style="cursor: pointer;">
                <div class="copilot-step-circle"><span class="num">6</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
                <div class="step-label-wrapper">
                    <span>Entegrasyon</span>
                </div>
                <div class="tooltip-text">
                    Sentez ve çözümleme aşaması.
                    <br><br>
                    <span style="font-size: 10px; font-style: italic; color: #cbd5e1;">Sohbette bu adıma gitmek için tıklayın</span>
                </div>
            </div>
...
$new_index = substr_replace($index, $tab3_new, $pos_start, $pos_end - $pos_start);
file_put_contents("frontend/index.php", $new_index);
echo "Replaced index.php layout\n";
?>
